...
import 'package:getx_to_do_list/app/modules/detail/widgets/doing_list.dart';
import 'package:getx_to_do_list/app/modules/detail/widgets/done_list.dart';
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        ...
                        totalSteps: homeCtrl.isTodosEmpty(task)
                            ? 1
                            : task.todos!.length,
